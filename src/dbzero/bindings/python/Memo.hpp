...

{
    ...
    template <typename MemoImplT> bool PyMemoType_Check(PyObject *);
    ...
    extern template bool PyMemoType_Check<MemoObject>(PyObject *);
    extern template bool PyMemoType_Check<MemoImmutableObject>(PyObject *);
