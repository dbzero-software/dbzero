...

{
    ...
    bool SparseIndex::ItemCompT::operator()(const Item &lhs, const Item &rhs) const 
    {
    ...
    bool SparseIndex::ItemCompT::operator()(const Item &lhs, std::pair<std::uint64_t, std::uint32_t> rhs) const 
    {
    ...
    bool SparseIndex::ItemCompT::operator()(std::pair<std::uint64_t, std::uint32_t> lhs, const Item &rhs) const 
    {        
