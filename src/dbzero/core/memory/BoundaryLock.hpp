...

{
    ...
    */
    ...
    {
    public:
        BoundaryLock(BaseStorage &, std::uint64_t address, std::shared_ptr<DP_Lock> lhs, std::size_t lhs_size,
        ...
        BoundaryLock(BaseStorage &, std::uint64_t address, const BoundaryLock &lock, std::shared_ptr<DP_Lock> lhs, std::size_t lhs_size,
