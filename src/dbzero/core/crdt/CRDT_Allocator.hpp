...
DB0_PACKED_BEGIN
        ...
        struct DB0_PACKED_ATTR Alloc
        {
            ...
            */
            ...
            std::pair<std::uint32_t, std::uint32_t> findAllocation(std::uint32_t address) const;
...
DB0_PACKED_END
    ...
    public:
        ...
        */
        ...
        std::pair<std::uint64_t, std::size_t> findAllocation(std::uint64_t address) const;
