...
namespace tests
{
    ...
    TEST_F( EmbeddedTupleTest , testTupleStoresInlineAndVariableLengthElements )
    {
        ...
        ASSERT_EQ(tuple->item(0).storageClass(), StorageClass::INT64);
        ASSERT_EQ(asInt64(tuple->item(0)), 42);
        ASSERT_EQ(tuple->item(1).storageClass(), StorageClass::STRING_REF);
        ASSERT_EQ(asString(tuple->item(1)), "alpha");
        ASSERT_EQ(tuple->item(2).storageClass(), StorageClass::BOOLEAN);
        ASSERT_TRUE(asBool(tuple->item(2)));
        ASSERT_EQ(tuple->item(3).storageClass(), StorageClass::DB0_BYTES);
    ...
    TEST_F( EmbeddedTupleTest , testTupleSurvivesReopen )
    {
        ...
        ASSERT_EQ(tuple->item(0).storageClass(), StorageClass::NONE);
    ...
    TEST_F( EmbeddedTupleTest , testPyTupleConstructsFromPythonTuple )
    {
        ...
        ASSERT_EQ(tuple->item(2).storageClass(), StorageClass::BOOLEAN);
        ASSERT_TRUE(asBool(tuple->item(2)));
        ASSERT_EQ(tuple->item(3).storageClass(), StorageClass::FP_NUMERIC64);
        ASSERT_EQ(asDouble(tuple->item(3)), 4.5);
        ASSERT_EQ(tuple->item(4).storageClass(), StorageClass::DB0_BYTES);
